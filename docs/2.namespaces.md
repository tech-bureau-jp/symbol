...
!example create_namespace_registration_transaction_root
...
Child namespace:
!example create_namespace_registration_transaction_child
...
!example create_namespace_metadata_transaction_new

Modify the above metadata.
!example create_namespace_metadata_transaction_modify
