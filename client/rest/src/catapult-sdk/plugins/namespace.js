...
const getAliasBasicType = (type) =>
  AliasType[type] || "namespaceDescriptor.alias.empty";
...
export default {
  registerSchema: (builder) => {
    ...
    builder.addTransactionSupport(
      models.TransactionType.NAMESPACE_REGISTRATION,
      {
    ...
    builder.addSchema("namespaceDescriptor", {
      ...
      namespace: {
        ...
        schemaName: "namespaceDescriptor.namespace",
      },
    });
    ...
    builder.addSchema("namespaceDescriptor.namespace", {
      ...
      alias: {
        type: ModelType.object,
        schemaName: (entity) => getAliasBasicType(entity.type),
      },
