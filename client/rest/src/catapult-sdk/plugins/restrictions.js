...
export default {
  AccountRestrictionType: Object.freeze({
    ...
    addressBlock:
      AccountRestrictionTypeFlags.address + accountRestrictionTypeBlockOffset,
    mosaicAllow: AccountRestrictionTypeFlags.mosaic,
    mosaicBlock:
      AccountRestrictionTypeFlags.mosaic + accountRestrictionTypeBlockOffset,
    operationAllow: AccountRestrictionTypeFlags.operation,
    operationBlock:
      AccountRestrictionTypeFlags.operation + accountRestrictionTypeBlockOffset,
  }),
  ...
  registerSchema: (builder) => {
    ...
    accountRestrictionTypeDescriptors.forEach((restrictionTypeDescriptor) => {
      ...
      builder.addTransactionSupport(restrictionTypeDescriptor.entityType, {
        ...
        restrictionAdditions: {
          ...
          schemaName: restrictionTypeDescriptor.valueType,
        },
      ...
      builder.addSchema(
        `accountRestriction.${restrictionTypeDescriptor.schemaPrefix}AccountRestriction`,
        {
          restrictionFlags: ModelType.uint16,
          values: {
            type: ModelType.array,
    ...
    builder.addSchema("accountRestrictions", {
      accountRestrictions: {
        ...
        schemaName: "accountRestriction.restrictions",
      },
    });
      ...
      restrictions: {
        ...
        schemaName: (entity) => {
          for (let i = 0; i < accountRestrictionTypeDescriptors.length; i++) {
            if (
              (entity.restrictionFlags & 0x3fff) ===
              accountRestrictionTypeDescriptors[i].flag
            )
    ...
    builder.addTransactionSupport(
      models.TransactionType.MOSAIC_ADDRESS_RESTRICTION,
      {
    ...
    builder.addTransactionSupport(
      models.TransactionType.MOSAIC_GLOBAL_RESTRICTION,
      {
        mosaicId: ModelType.uint64HexIdentifier,
    ...
    builder.addSchema("mosaicRestrictions", {
      ...
      mosaicRestrictionEntry: {
        type: ModelType.object,
        schemaName: "mosaicRestrictions.entry",
      },
    });
    builder.addSchema("mosaicRestrictions.entry", {
      ...
      restrictions: {
        type: ModelType.array,
        schemaName: "mosaicRestrictions.entry.restrictions",
      },
    });
    builder.addSchema("mosaicRestrictions.entry.restrictions", {
      ...
      restriction: {
        type: ModelType.object,
        schemaName: "mosaicRestrictions.entry.restrictions.restriction",
      },
    });
