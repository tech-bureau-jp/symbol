...
class NemFacadeTest(unittest.TestCase):
        ...
        transaction = facade.transaction_factory.create(
            {
                ...
                "amount": 5100000,
                "message": {"message_type": "plain", "message": "blah blah"},
            }
        )
        return transaction
    ...
    def _create_real_multisig_transaction():
        ...
        inner_transaction = factory.to_non_verifiable_transaction(
            NemFacadeTest._create_real_transfer()
        )
        transaction = facade.transaction_factory.create(
            {
    ...
    def test_can_create_via_repository(self):
        ...
        self.assertEqual(
            str(NemFacade.Address("TALIC33PNVKIMNXVOCOQGWLZK52K4XALZBNE2ISF")).encode(
                "utf8"
            ),
    ...
    def test_can_create_public_account_from_public_key(self):
        ...
        # Assert:
        self.assertEqual(
            facade.Address("TCFGSLITSWMRROU2GO7FPMIUUDELUPSZUNUEZF33"), account.address
        )
    ...
    def test_can_hash_transaction(self):
        ...
        # Assert:
        self.assertEqual(
            Hash256("A7064DB890A4E7329AAB2AE7DCFA5EC76D7E374590C61EC85E03C698DF4EA79D"),
            hash_value,
        )
    ...
    def test_can_hash_multisig_transaction(self):
        ...
        # Assert:
        self.assertEqual(
            Hash256("B585BC092CDDDCBA535FD6C0DE38F26EB44E6BA638A0BA6DFAD4BAA7E7AAE1B8"),
            hash_value,
        )
    ...
    def test_can_verify_signed_multisig_transaction(self):
        self._assert_can_verify_transaction(
            self._create_real_multisig_transaction(), self._sign_transaction
        )

    def test_can_verify_signed_multisig_transaction_signing_payload(self):
        self._assert_can_verify_transaction(
            self._create_real_multisig_transaction(),
            self._sign_transaction_signing_payload,
        )
    ...
    def _assert_bip32_child_public_keys(self, passphrase, expected_child_public_keys):
        ...
        # Act:
        root_node = Bip32(NemFacade.BIP32_CURVE_NAME).from_mnemonic(
    ...
    def test_can_use_bip32_derivation_without_passphrase(self):
        self._assert_bip32_child_public_keys(
            ...
            [
                PublicKey(
                    "6C42BFAD2199CCB5C64E59868CC7A3F2AD29BDDCEB9754157DF136535E6B5EBA"
                ),
                PublicKey(
                    "782FF2375F75524106356092B4EE4BA098D28CF6571F1643867B9A11AEF509C6"
                ),
                PublicKey(
                    "20EEEFCAE026EBB3C3C51E9AF86A97AA146B34A5463CFE468B37C3CB49682408"
                ),
            ],
        )
    ...
    def test_can_use_bip32_derivation_with_passphrase(self):
        self._assert_bip32_child_public_keys(
            ...
            [
                PublicKey(
                    "3BE4759796DD507D6E410CD8C65121E7E42DAC69699A9058E1F7663A390122CE"
                ),
                PublicKey(
                    "6B288C00800EC9FC0C30F35CEAFC2C5EC4066C2BE622822AAC70D67F215E5E6D"
                ),
                PublicKey(
                    "1AC159878D327E578C0130767E960C265753CAD5215FC992F1F71C41D00EADA3"
                ),
            ],
        )
