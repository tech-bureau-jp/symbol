...
class NemFacade:
        ...
        if self.account_descriptor_repository:
            type_parsing_rules = (
                self.account_descriptor_repository.to_type_parsing_rules_map(
                    self._create_nem_type_to_property_mapping()
                )
            )
    ...
    def _create_nem_type_to_property_mapping():
        return {Address: "address", PublicKey: "public_key"}
    ...
    def hash_transaction(transaction):
        ...
        non_verifiable_transaction = TransactionFactory.to_non_verifiable_transaction(
            transaction
        )
